  ...
  <form>
    ...
    <div class="projectdetails">
      <div class="labels">
        ...
        <Input
          label="1.3 Project Description*"
          placeholder="Flat with all facilities..."
        />
      </div>
      <div class="bigdiv">
        <Input
          label="1.4 Explanatory Note by Promoter (Reasons)*"
          placeholder="Guidance on Scenario (Circular 8 - PDF)"
        />
      </div>
      <div class="labels">
        ...
        <Input
          label="1.7 Total Land Area of Approved layout(Sq Mtrs.)*"
          placeholder="5432223"
        />
      </div>
      <div class="labels">
        ...
        <Input
          label="1.10 Land Area for Project Under Registration*"
          placeholder="66544"
        />
      </div>
      <div class="labels">
        <Input
          label="1.11 Total Carpet Area under approved layout*"
          placeholder="544344"
        />
        <Input
          label="1.12 Total Carpet Area for Project under registration"
          placeholder="4500"
        />
      ...
      <div class="labels">
        <Input
          label="1.17 Area of Open Parking*(Sq. Mtrs)"
          placeholder="453389"
        />
        <Input
          label="1.18 Area of Covered Parking*(Sq. Mtrs)"
          placeholder="1298776"
        />
      </div>
    ...
    <div id="head2div">
      ...
      <div class="labels">
        ...
        <Input
          label="1.25 Mojlo (Add Multiple Mojle separated by comma)*"
          placeholder="mojlo/abc"
        />
      </div>
      <div class="longlabels labels">
        <Input
          label="1.26 Revenue Survey No./Block No.(Add multiple Revenue Survey Nos. seperated by comma)*"
          placeholder="na"
        />
      ...
      <div class="labels Adrlabels">
        <Input
          label="1.28 Project Address Line 1*"
          placeholder="Vastrapur Road"
        />
      ...
      <div class="labels">
        <Input
          label="1.33 Town Planning Authority"
          placeholder="Balva Muncipality"
        />
    ...
    <div>
      <section>
        ...
        <div class="projectdetails">
          <div class="labels">
            <Input
              label="1.35 Fire Station Distance from the Projects(Km)"
              placeholder="2"
            />
            <Input
              label="1.36 Multi-Speciality Hospital Distance From Projects(Km)"
              placeholder="2"
            />
            <Input
              label="1.37 Main Railways Station Distance from the Projects(Km)"
              placeholder="2"
            />
          </div>
          <div class="labels">
            <Input
              label="1.38 Police Station Distance from the Projects(Km)"
              placeholder="2"
            />
            <Input
              label="1.39 Public Garden Distance From Projects(Km)"
              placeholder="2"
            />
            <Input
              label="1.40 Public Transit Distance from the Projects(Km)"
              placeholder="2"
            />
          </div>
          <div class="labels longlabels">
            <Input
              label="1.41 ULB Service delivery point Distance from the Projects(Km)"
              placeholder="2"
            />
            <Input
              label="1.42 Airport Distance From Projects(Km)"
              placeholder="2"
            />
          </div>
        </div>
      ...
      <section className="bankDetail">
        <div class="labels">
          <Input
            label="1.44 A/c Holder Name as per Bank Statement/ Passbook"
            placeholder=""
          />
        ...
        <Input
          label="1.53 RERA Bank Account Statement or First Page of Passbook"
          placeholder="mojlo/abc"
        />
