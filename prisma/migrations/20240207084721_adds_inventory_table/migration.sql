...
CREATE TABLE "Inventorydetail" (
    ...
    "Area_balcony" INTEGER NOT NULL,
    "Area_terrace" INTEGER NOT NULL,
    "No_inventory_booked" INTEGER NOT NULL,
...
CREATE TABLE "project_details" (
    ...
    CONSTRAINT "project_details_pkey" PRIMARY KEY ("project_name")
);
